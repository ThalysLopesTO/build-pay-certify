...
DROP TRIGGER IF EXISTS subtasks_updated_at_trigger ON public.subtasks;
...
DROP POLICY IF EXISTS "Admins and foremen can create tasks" ON public.tasks;
DROP POLICY IF EXISTS "Admins and foremen can update all tasks" ON public.tasks;
DROP POLICY IF EXISTS "Employees can update assigned tasks" ON public.tasks;
DROP POLICY IF EXISTS "Admins and foremen can delete tasks" ON public.tasks;
DROP POLICY IF EXISTS "Users can view task assignees" ON public.task_assignees;
DROP POLICY IF EXISTS "Admins and foremen can manage assignees" ON public.task_assignees;
DROP POLICY IF EXISTS "Users can view company tags" ON public.task_tags;
DROP POLICY IF EXISTS "Users can create company tags" ON public.task_tags;
DROP POLICY IF EXISTS "Admins can manage tags" ON public.task_tags;
DROP POLICY IF EXISTS "Users can view task tag links" ON public.task_tag_links;
DROP POLICY IF EXISTS "Admins and foremen can manage tag links" ON public.task_tag_links;
DROP POLICY IF EXISTS "Users can view subtasks" ON public.subtasks;
DROP POLICY IF EXISTS "Admins and foremen can manage subtasks" ON public.subtasks;
DROP POLICY IF EXISTS "Employees can update assigned subtasks" ON public.subtasks;
DROP POLICY IF EXISTS "Users can view subtask assignees" ON public.subtask_assignees;
DROP POLICY IF EXISTS "Admins and foremen can manage subtask assignees" ON public.subtask_assignees;
DROP POLICY IF EXISTS "Users can view subtask tag links" ON public.subtask_tag_links;
DROP POLICY IF EXISTS "Admins and foremen can manage subtask tag links" ON public.subtask_tag_links;
