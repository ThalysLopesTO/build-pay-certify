-- Update get_client_portal_data to include invoice line items and calculate tax amount
    ...
    'invoices', (
      ...
      FROM (
        SELECT json_build_object(
          ...
          'tax_amount', ROUND((COALESCE(i.subtotal, 0) - COALESCE(i.discount, 0)) * COALESCE(i.tax, 0) / 100, 2),
          'discount', i.discount,
          'line_items', (
            SELECT COALESCE(
              json_agg(json_build_object(
                ...
                'unit_price', COALESCE(ili.unit_price, ili.amount),
                'amount', ili.amount
