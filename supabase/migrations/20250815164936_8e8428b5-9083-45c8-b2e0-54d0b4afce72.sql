...
DROP POLICY IF EXISTS "Company admins can update company profiles safely" ON public.user_profiles;
DROP POLICY IF EXISTS "Users can update limited fields on own profile" ON public.user_profiles;
