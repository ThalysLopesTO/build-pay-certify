  ...
  <div style="max-width:600px;margin:40px auto;background-color:#fff;border-radius:12px;box-shadow:0 2px 6px rgba(0,0,0,0.08);overflow:hidden;">
    ...
    <div style="padding:30px 40px;text-align:left;line-height:1.6;">
      ...
      <p style="margin-top:30px;">
        ...
        <a href="mailto:Contact@stackbuild.ca" style="color:#10b981;text-decoration:none;">support@stackbuild.ca</a>.
      </p>
    ...
    if (requestBody.firstName && requestBody.password) {
      ...
      return new Response(
        JSON.stringify({
          success: false,
          error:
            "Invalid request: must provide either StackBuild welcome parameters (firstName, password) or generic email parameters (html, subject)",
        }),
        {
          status: 400,
          headers: { "Content-Type": "application/json", ...corsHeaders },
