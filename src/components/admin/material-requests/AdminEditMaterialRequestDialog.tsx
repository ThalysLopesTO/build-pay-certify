...
import FileUploadField from '../../foreman/FileUploadField';
import { useMaterialRequestEditAdmin } from '@/hooks/useMaterialRequestEditAdmin';
...
interface AdminEditMaterialRequestDialogProps {
  request: MaterialRequest;
  isAdmin: boolean;
  trigger?: React.ReactNode;
}

const AdminEditMaterialRequestDialog: React.FC<AdminEditMaterialRequestDialogProps> = ({
  request,
  isAdmin,
  trigger,
}) => {
  const [open, setOpen] = React.useState(false);
  const editMutation = useMaterialRequestEditAdmin();
      ...
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle className="flex items-center space-x-2">
            ...
            <span>Admin Edit Material Request</span>
          </DialogTitle>
        </DialogHeader>
...
export default AdminEditMaterialRequestDialog;
