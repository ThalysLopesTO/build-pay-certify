            ...
            <div className="overflow-y-auto flex-1 px-4 pb-4">
              <form onSubmit={handleSubmit} className="space-y-4 pt-4">
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="expense_title_mobile" className="text-sm font-medium text-slate-700">
                      {transactionType === 'income' ? 'Income' : 'Expense'} Title *
                    </Label>
                    <Input
                      id="expense_title_mobile"
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="vendor_payee_mobile" className="text-sm font-medium text-slate-700">
                      {transactionType === 'income' ? 'Payer' : 'Vendor / Payee'} *
                    </Label>
                    <Input
                      id="vendor_payee_mobile"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="amount_mobile" className="text-sm font-medium text-slate-700">
                      Amount (CAD) *
                    </Label>
                    <div className="relative">
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="payment_status_mobile" className="text-sm font-medium text-slate-700">
                      Payment Status
                    </Label>
                    <Select 
                ...
                {/* Payment Method */}
                <div className="space-y-2">
                  <Label htmlFor="payment_method_mobile" className="text-sm font-medium text-slate-700">
                    Payment Method
                  </Label>
                  <Select 
                ...
                {/* Notes */}
                <div className="space-y-2">
                  <Label htmlFor="notes_mobile" className="text-sm font-medium text-slate-700">
                    Notes
                  </Label>
                  <Textarea
                    id="notes_mobile"
                ...
                {transactionType === 'expense' && (
                  <div className="space-y-4 border-t pt-4">
                    <div className="flex items-center space-x-3">
                      ...
                      />
                      <Label htmlFor="is_recurring_mobile" className="text-sm font-medium text-slate-700">
                ...
                <div className="flex flex-col gap-3 pt-6 border-t">
                  <Button 
                    type="submit"
                    className="w-full px-6 h-11 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white shadow-sm"
                  >
                  ...
                  <Button 
                    ...
                    variant="outline" 
                    onClick={resetForm}
                    className="w-full px-6 h-11 border-slate-300 hover:bg-slate-50"
                  >
                    Cancel
                  </Button>
                </div>
