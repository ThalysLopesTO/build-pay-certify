...
import { CollapsibleMaterialCategorySelector } from '@/components/admin/material-catalog/CollapsibleMaterialCategorySelector';
    ...
    <Card className={`${errors[item.id] ? 'border-destructive' : ''}`}>
      <CardContent className="p-4 space-y-4">
        ...
        <div>
          ...
          <CollapsibleMaterialCategorySelector
