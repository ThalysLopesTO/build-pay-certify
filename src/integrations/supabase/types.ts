  ...
  public: {
    Tables: {
      ...
      daily_task_activity_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "daily_task_activity_log_item_id_fkey"
            columns: ["item_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "daily_task_activity_log_list_id_fkey"
            columns: ["list_id"]
            isOneToOne: false
            referencedRelation: "daily_task_lists"
            referencedColumns: ["id"]
          },
        ]
      }
      daily_task_comments: {
        ...
        Relationships: [
          {
            foreignKeyName: "daily_task_comments_item_id_fkey"
            columns: ["item_id"]
            isOneToOne: false
            referencedRelation: "daily_task_items"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "daily_task_comments_list_id_fkey"
            columns: ["list_id"]
            isOneToOne: false
            referencedRelation: "daily_task_lists"
            referencedColumns: ["id"]
      ...
      daily_task_item_assignees: {
        ...
        Relationships: [
          {
            foreignKeyName: "daily_task_item_assignees_item_id_fkey"
            columns: ["item_id"]
            isOneToOne: false
            referencedRelation: "daily_task_items"
            referencedColumns: ["id"]
      ...
      daily_task_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "daily_task_items_list_id_fkey"
            columns: ["list_id"]
            isOneToOne: false
            referencedRelation: "daily_task_lists"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "daily_task_items_parent_item_id_fkey"
      ...
      daily_task_lists: {
        ...
        Relationships: [
          {
            foreignKeyName: "daily_task_lists_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "daily_task_lists_jobsite_id_fkey"
            columns: ["jobsite_id"]
            isOneToOne: false
            referencedRelation: "jobsites"
            referencedColumns: ["id"]
      ...
      daily_task_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "daily_task_templates_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "daily_task_templates_jobsite_id_fkey"
            columns: ["jobsite_id"]
            isOneToOne: false
            referencedRelation: "jobsites"
            referencedColumns: ["id"]
